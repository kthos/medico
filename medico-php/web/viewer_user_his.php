<?php
if(empty($_GET['qazwsxedcr112233']) ){
     //echo "<div style='margin:25;color:white'><h1>No secret key!!!</h1></div>";
     //exit;
}
if (empty($_GET['file'])) {
    echo "<div style='margin:25;color:white'><h1>Click Document On Left Side!!!</h1></div>";
    exit;
}

require './config/con_db_his.php';
require './get_real_ip.php';
require './config/allow_ip.php';

$ip = getRealIp();

if (count($allow_ip) > 0) {
    if (!in_array($ip, $allow_ip)) {        
        echo "<div style='margin:25;color:white'><h1>Your IP is denied !!!</h1></div>";
        exit;
    }
}

if ($his == 'hos3') {
    $sql = "SELECT  t.kskloginname 'hos_user' FROM  onlineuser t where t.computername ='$ip' limit 1"; //hos3
}
if ($his == 'hos4') {
    $sql = " select o1.kskloginname hos_user,o1.ip_address,o1.ksklogintime,o3.name ,o3.entryposition,o1.department,o1.depcode,o2.last_active  from onlineuser o1  
left outer join onlineuser_idle o2 on o1.onlineid=o2.onlineid  left outer join opduser o3  on o1.kskloginname = o3.loginname  
left outer join computer_hardware c2 on c2.computer_name = o1.computername  left outer join computer_bandwidth c1 on c1.computer_name = o1.computername 
where o2.last_active is not  null
AND o1.ip_address = '$ip'
ORDER BY o1.ksklogintime DESC "; //hos4
}
...
if ($count > 0) {
    ...
    echo "<div style='margin:25;color:white'><h1>Please Sign On to HIS !!!</h1></div>";
    //exit; // uncomment Here to stop test.
}
...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
    <head>
        ...
        <script src="viewer_user_his.js"></script>

    </head>

    <body tabindex="1" class="loadingInProgress" oncontextmenu="return false">
        <div class="water-mark-utehn"><h1><?= $user ?> <?= $ip ?> (<?= date('Ymd H:i:s') ?>)</h1></div>  
        <div id="outerContainer">
            ...
            <div id="overlayContainer" class="hidden">
                ...
                <div id="documentPropertiesOverlay" class="container hidden" style="display: none">
                    <div class="dialog">
                        <div class="row">
...
if (!empty($_GET['file'])) {
    $file = $_GET['file'];
    $sql = "insert into medico_scan_log (id,host,username,file_request,date_request,note1) values (UUID_SHORT(),'$ip','$user','$file',now(),'his')";
