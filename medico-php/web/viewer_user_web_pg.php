...
require './config/con_db_his_pg.php';
...
$sql = "select his_user as logged  from medico_scan_user_web where  is_allow = '1' and his_user='$user'";
...
if (!empty($_GET['file'])) {
    $file = $_GET['file'];
    $sql = "insert into medico_scan_log (id,host,username,file_request,date_request,note1) values (uuid_generate_v4(),'$ip','$user','$file',now(),'web')";
